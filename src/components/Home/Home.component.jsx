...
import newBg from "../../assets/nightLights.jpg";
  ...
  return (
    <>
        ...
        <div className="relative border-t-2 border-white">
            <div 
                className=" hidden dark:bg-fixed dark:bg-no-repeat dark:bg-contain dark:absolute  dark:w-[20%] dark:h-[100%] z-0 mt-10 dark:md:block"
                style={{backgroundImage: `url(${newBg})`}}

            />

            <div 
                className=" hidden md:block dark:hidden bg-fixed bg-no-repeat bg-left bg-contain absolute w-[35%] h-[100%] z-0 "
                style={{backgroundImage: `url(${mountainBg})`}}

            />
            
            <div className=" block px-20 md:flex md:flex-col md:flex-wrap md:items-between md:items-center border-t-2 border-white dark:border-black">
